...
import 'package:subash/RatingPackage.dart';
...
class _sliState extends State<sli> {
  ...
  Widget build(BuildContext context) {
    ...
    onTap: ()
    {
    Navigator.push(context, MaterialPageRoute(builder: (context) => const newapps4())
    );
    },
              child: Icon(Icons.account_circle,color: Colors.black,)),label: "Account"),
          BottomNavigationBarItem(icon: GestureDetector(
    ...
    Navigator.push(context, MaterialPageRoute(builder: (context) => const app0())
              ...
              child: Icon(Icons.library_add,color: Colors.blue,)),label: "Library"),
          BottomNavigationBarItem(icon: GestureDetector(
    ...
    child: Icon(Icons.multitrack_audio,color: Colors.green,)),label: "premium"),
        ...
        slivers:[ SliverAppBar(
          ...
          actions: [
            ...
            Padding(
              ...
              child: Icon(Icons.download_for_offline,color: Colors.white,size: 30,),
            )
          ],
          expandedHeight: 300.0,
          flexibleSpace: FlexibleSpaceBar(
            title: Text('Hot Hits Tamil',
              style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30,color: Colors.lightGreen),textScaleFactor: 1,),
            background: Container(
              ...
              child: Container(
                child: Image.asset('assets/img/leo.jpg',
                  fit: BoxFit.fill,),
              ),
            ),
          ...
          SliverAppBar(
            ...
            actions: [
              ...
              child: Icon(Icons.play_arrow,size: 40,),radius: 40,)
            ],
            title: Row(
              children: [SizedBox(width: 5,),
                Icon(Icons.download_for_offline,color: Colors.white,size: 40,),
                SizedBox(width: 5,),
                  ...
                  return ListTile(
                    ...
                    title: Row(
                      children: [
                        Column(
                          children: [
                            Text('Naa Ready(From "Leo")',style: TextStyle(color: Colors.white),
                            ),
                            Row(
                              children: [SizedBox(width: 5,),
                                RichText(
                                  text: TextSpan(
                                      ...
                                      children: [
                                        TextSpan(text: 'LYRICS',
                                          style: TextStyle
                                            (fontWeight: FontWeight.bold,fontSize: 15,background: Paint()
                                ...
                                SizedBox(width: 5,),
                                Text('   Thalapathy',style: TextStyle(color: Colors.orange),)
                              ],
                            ),
